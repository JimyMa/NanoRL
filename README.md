...
Ray-orchestrated reinforcement learning for large language models. **GRPO** with **megatron-core** training (DDP single-rank or FSDP/ZeRO-3 multi-rank), **NanoInfra** rollouts, and **DLSlime** moving both trajectories and weight tensors over RDMA.
